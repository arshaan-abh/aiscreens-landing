  ...
  return (
    <Sheet>
      ...
      <div className="grid w-main max-w-full grid-cols-[repeat(16,1fr)] grid-rows-[repeat(16,1fr)] gap-4 px-8">
        <FancyCard
          className="col-end-17
            sm:row-end-17
            col-start-1 row-start-6 row-end-8
            sm:col-start-1 sm:col-end-9 sm:row-start-11
        ...
        <FancyCard
          className="col-end-17
            sm:col-end-17
            col-start-1 row-start-1 row-end-6
            sm:col-start-1 sm:row-start-1 sm:row-end-6
        ...
        <a
          href="#testimonial"
          className="col-end-17 row-start-14 row-end-16
            sm:col-end-17 sm:row-end-14
            col-start-1
            flex flex-col rounded-2xl bg-cyan-500 p-4
            sm:col-start-9 sm:row-start-11
        ...
        <FancyCard
          className="col-end-17 row-end-14
            sm:col-end-17
            col-start-1 row-start-8
            sm:col-start-1 sm:row-start-6 sm:row-end-11
        ...
        <a
          ...
          className="col-end-17 row-start-16 row-end-17
            sm:row-start-14 sm:row-end-17
            sticky bottom-8 z-10
            col-start-9
            flex flex-col rounded-2xl bg-rose-600 p-4
            sm:static sm:col-start-9 sm:col-end-13
        ...
        <a
          ...
          className="row-start-16 row-end-17
            sm:col-end-17 sm:row-start-14 sm:row-end-17
            sticky bottom-8 z-10
            col-start-1 col-end-9
            flex flex-col rounded-2xl bg-rose-600 p-4
            sm:static sm:col-start-13
            lg:col-span-2 lg:row-span-5"
        >
          <LinkIcon className="mb-2" />
          <div className="hidden text-sm capitalize sm:flex">
