...
export const ImageBorder: FC<IconProps> = (props) => {
  const { refProp, ...otherProps } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        fillRule="evenodd"
        d="M27 0h.175a2.33 2.33 0 1 1 0 4.661c-5.922 0-10.129.005-13.321.434-3.125.42-4.925 1.208-6.239 2.523s-2.102 3.116-2.522 6.242c-.429 3.193-.434 7.402-.434 13.327a2.33 2.33 0 0 1-2.329 2.33A2.33 2.33 0 0 1 0 27.187v-.175c0-5.71 0-10.233.476-13.772.49-3.643 1.521-6.591 3.845-8.916S9.592.966 13.233.476C16.771 0 21.292 0 27 0zm327.146 5.095c-3.192-.429-7.399-.434-13.321-.434a2.33 2.33 0 1 1 0-4.661H341c5.708 0 10.228 0 13.767.476 3.641.49 6.588 1.522 8.912 3.847s3.356 5.274 3.845 8.916c.476 3.54.476 8.062.476 13.772v.175a2.33 2.33 0 0 1-2.329 2.33 2.33 2.33 0 0 1-2.33-2.33c0-5.925-.005-10.134-.434-13.327-.42-3.126-1.208-4.927-2.522-6.242s-3.115-2.103-6.239-2.523zM2.329 151.372a2.33 2.33 0 0 1 2.329 2.331c0 5.924.005 10.133.434 13.326.42 3.126 1.208 4.927 2.522 6.242s3.115 2.103 6.239 2.523c3.192.43 7.399.435 13.321.435a2.33 2.33 0 0 1 0 4.66H27c-5.707 0-10.228 0-13.766-.476-3.641-.489-6.588-1.521-8.913-3.846S.965 171.293.476 167.65C0 164.111 0 159.588 0 153.878v-.175a2.33 2.33 0 0 1 2.329-2.331zm363.342 0a2.33 2.33 0 0 1 2.329 2.331v.175c0 5.71 0 10.233-.476 13.772-.489 3.643-1.521 6.591-3.845 8.917s-5.271 3.357-8.912 3.846c-3.538.476-8.059.476-13.767.476h-.175a2.33 2.33 0 0 1 0-4.66c5.922 0 10.129-.005 13.321-.435 3.125-.42 4.925-1.208 6.239-2.523s2.102-3.116 2.522-6.242c.43-3.193.434-7.402.434-13.326a2.33 2.33 0 0 1 2.33-2.331z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Quotes: FC<IconProps> = (props) => {
  const { refProp, ...otherProps } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        d="M36.55 41.621c4.351 1.92 7.745 4.799 10.182 8.638s3.655 8.377 3.655 13.612c0 7.504-2.35 13.612-7.049 18.324C38.639 86.731 32.634 89 25.324 89s-13.402-2.356-18.275-7.068C2.35 77.221 0 71.2 0 63.871c0-3.49.435-6.98 1.305-10.471s2.785-8.725 5.744-15.706L22.191 0h25.846L36.55 41.621zm61.613 0c4.351 1.92 7.745 4.799 10.182 8.638S112 58.635 112 63.871c0 7.504-2.35 13.612-7.049 18.324C100.252 86.731 94.247 89 86.937 89s-13.402-2.356-18.275-7.068c-4.699-4.712-7.049-10.732-7.049-18.062 0-3.49.435-6.98 1.305-10.471s2.785-8.725 5.744-15.706L83.804 0h25.846L98.163 41.621z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <g fill="currentColor">
        <path
          fillRule="evenodd"
          d="M7.528 2.206c-.262.343-.559.872-.989 1.644l-.218.392-.039.07c-.2.361-.37.665-.642.872s-.612.285-1.002.372l-.076.017-.424.096-1.796.473c-.381.15-.461.273-.491.371-.032.104-.033.263.194.624.231.367.62.824 1.19 1.49l.289.338.05.058c.269.313.493.575.595.905s.068.674.027 1.092l-.008.078-.044.451-.124 1.94c.02.44.112.561.186.617.066.05.187.105.583-.008.402-.115.936-.36 1.72-.72l.397-.183.073-.034c.363-.168.678-.314 1.022-.314s.659.146 1.022.314l.073.034.397.183 1.72.72c.396.113.517.058.583.008.074-.056.167-.178.186-.617s-.038-1.052-.124-1.94l-.044-.451-.008-.078c-.041-.418-.075-.764.027-1.092s.327-.592.595-.905l.05-.058.289-.338 1.19-1.49c.228-.361.227-.52.194-.624-.031-.098-.111-.221-.491-.371-.39-.154-.959-.284-1.796-.473l-.424-.096-.076-.017c-.39-.088-.726-.163-1.002-.372s-.442-.512-.642-.872l-.039-.07-.218-.392-.989-1.644c-.262-.342-.396-.372-.472-.372s-.21.03-.472.372zm-.794-.608C7.052 1.183 7.445.833 8 .833s.948.349 1.266.764c.312.408.643 1.002 1.048 1.728l.239.429c.262.469.329.569.413.633s.185.096.694.211l.467.106 1.9.509c.488.192.915.476 1.08 1.005.163.523-.02 1.005-.303 1.454-.275.436-.713.949-1.249 1.576l-.316.37c-.345.403-.417.502-.45.61s-.031.239.021.777l.048.492.124 2.04c-.024.529-.144 1.038-.581 1.369-.445.338-.963.3-1.463.157-.485-.139-1.089-.417-1.823-.755l-.437-.201c-.478-.22-.581-.256-.677-.256s-.198.035-.677.256l-.437.201-1.823.755c-.5.143-1.018.181-1.463-.157-.437-.332-.557-.84-.581-1.369-.023-.52.043-1.203.124-2.04l.048-.492c.052-.537.055-.665.021-.777s-.106-.207-.451-.61l-.316-.37-1.249-1.576C.914 7.222.731 6.74.894 6.217c.164-.529.592-.812 1.08-1.005.47-.185 1.116-.331 1.9-.509l.042-.01.424-.096c.509-.115.613-.149.694-.211s.151-.163.413-.633l.239-.429 1.048-1.728z"
        />
        <path d="M6.007 3.386C6.894 1.795 7.337 1 8 1s1.106.795 1.993 2.386l.229.411c.252.452.378.678.574.827s.441.204.93.315l.445.101c1.722.39 2.583.584 2.787 1.243s-.382 1.345-1.556 2.718l-.304.355c-.334.39-.5.585-.575.826s-.05.502.001 1.022l.046.474c.178 1.831.266 2.747-.27 3.154s-1.342.036-2.954-.706l-.417-.192c-.458-.211-.687-.316-.93-.316s-.472.105-.93.316l-.417.192c-1.612.742-2.418 1.113-2.954.706s-.447-1.323-.27-3.154l.046-.474c.05-.52.076-.781.001-1.022s-.242-.436-.575-.826l-.304-.355C1.422 7.628.835 6.942 1.04 6.283S2.106 5.43 3.828 5.04l.445-.101c.489-.111.734-.166.93-.315s.322-.375.574-.827l.229-.411z" />
      </g>
    </svg>
  );
};
...
export const PhoneCall: FC<IconProps> = (props) => {
  const { refProp, ...otherProps } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      ...
      {...otherProps}
    >
      <path d="M12.547 6.645l.811 1.454c.732 1.312.438 3.033-.715 4.186 0 0-1.399 1.399 1.137 3.935s3.934 1.138 3.935 1.137c1.153-1.153 2.874-1.447 4.186-.715l1.454.811c1.981 1.105 2.215 3.884.474 5.625-1.046 1.046-2.328 1.86-3.745 1.914-2.385.09-6.436-.513-10.499-4.576s-4.667-8.114-4.577-10.5c.054-1.417.868-2.699 1.914-3.745 1.741-1.741 4.519-1.507 5.625.474zm4.027-4.295a.94.94 0 0 1 1.077-.775l.187.037.441.114c.371.108.889.286 1.511.571 1.245.571 2.903 1.57 4.622 3.289s2.718 3.377 3.29 4.622a11.11 11.11 0 0 1 .571 1.511l.114.441.027.128.007.039c.083.511-.261 1.014-.772 1.097a.94.94 0 0 1-1.075-.771l-.017-.085-.084-.324a9.25 9.25 0 0 0-.475-1.254c-.487-1.063-1.364-2.531-2.911-4.078s-3.015-2.424-4.078-2.911c-.532-.244-.964-.391-1.254-.475l-.397-.1a.95.95 0 0 1-.784-1.077z" />
      <path
        fillRule="evenodd"
        d="M16.857 6.662a.94.94 0 0 1 1.159-.644l-.258.901.258-.901.002.001h.002l.004.001.01.003.025.008.07.024.221.087a6.44 6.44 0 0 1 .736.379c.612.362 1.447.964 2.428 1.945s1.583 1.816 1.945 2.428c.181.306.301.554.38.737l.087.221.024.071.008.025.003.01.001.004.001.002s0 .002-.901.259l.901-.258a.94.94 0 0 1-.644 1.159.94.94 0 0 1-1.155-.631l-.005-.014-.044-.11a4.59 4.59 0 0 0-.27-.52c-.279-.471-.782-1.183-1.657-2.057s-1.587-1.378-2.058-1.657c-.236-.14-.412-.223-.52-.27l-.11-.044-.014-.005a.94.94 0 0 1-.631-1.155z"
      />
    </svg>
  );
};

export const MapPoint: FC<IconProps> = (props) => {
  const { refProp, ...otherProps } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        fillRule="evenodd"
        d="M15 2.5C9.477 2.5 5 7.503 5 13.125c0 5.578 3.192 11.641 8.171 13.968 1.161.543 2.496.543 3.657 0C21.808 24.766 25 18.703 25 13.125 25 7.503 20.523 2.5 15 2.5zM15 15a2.5 2.5 0 1 0 0-5 2.5 2.5 0 1 0 0 5z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Letter: FC<IconProps> = (props) => {
  const { refProp, ...otherProps } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        fillRule="evenodd"
        d="M3.964 6.464C2.5 7.929 2.5 10.286 2.5 15s0 7.071 1.464 8.535S7.786 25 12.5 25h5c4.714 0 7.071 0 8.535-1.465S27.5 19.714 27.5 15s0-7.071-1.465-8.536S22.214 5 17.5 5h-5C7.786 5 5.429 5 3.964 6.464zM23.22 9.4a.94.94 0 0 1-.12 1.32l-2.746 2.288-2.799 2.182c-.826.531-1.63.866-2.556.866s-1.73-.335-2.556-.866c-.793-.51-1.691-1.258-2.799-2.181L6.9 10.72a.94.94 0 0 1-.12-1.32.94.94 0 0 1 1.32-.12l2.699 2.249 2.659 2.084c.662.425 1.111.568 1.542.568s.88-.143 1.542-.568c.684-.44 1.493-1.112 2.659-2.084L21.9 9.28a.94.94 0 0 1 1.32.12z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Youtube: FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      <path
        d="M13.6 20l6.228-3.6-6.228-3.6V20zm13.872-9.396c.156.564.264 1.32.336 2.28l.12 2.508L28 16.4c0 2.628-.192 4.56-.528 5.796-.3 1.08-.996 1.776-2.076 2.076-.564.156-1.596.264-3.18.336l-4.308.12L16 24.8c-5.028 0-8.16-.192-9.396-.528-1.08-.3-1.776-.996-2.076-2.076-.156-.564-.264-1.32-.336-2.28l-.12-2.508L4 16.4c0-2.628.192-4.56.528-5.796.3-1.08.996-1.776 2.076-2.076.564-.156 1.596-.264 3.18-.336l4.308-.12L16 8c5.028 0 8.16.192 9.396.528 1.08.3 1.776.996 2.076 2.076z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Instagram: FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      <path
        d="M19.84 16a3.84 3.84 0 0 1-2.37 3.548 3.84 3.84 0 0 1-4.185-.832 3.84 3.84 0 0 1-.832-4.185A3.84 3.84 0 0 1 16 12.16 3.85 3.85 0 0 1 19.84 16zM28 10.72v10.56A6.72 6.72 0 0 1 21.28 28H10.72A6.72 6.72 0 0 1 4 21.28V10.72A6.72 6.72 0 0 1 10.72 4h10.56A6.72 6.72 0 0 1 28 10.72zM21.76 16a5.76 5.76 0 0 0-3.556-5.321 5.76 5.76 0 0 0-6.277 1.249 5.76 5.76 0 0 0-1.249 6.277A5.76 5.76 0 0 0 16 21.76 5.76 5.76 0 0 0 21.76 16zm1.92-6.24a1.44 1.44 0 0 0-.889-1.33 1.44 1.44 0 0 0-1.569.312 1.44 1.44 0 0 0-.312 1.569 1.44 1.44 0 0 0 1.33.889 1.44 1.44 0 0 0 1.44-1.44z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Twitter: FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      <path
        d="M28 8.294a9.83 9.83 0 0 1-2.822.792 4.93 4.93 0 0 0 2.157-2.73c-.952.574-2.008.975-3.12 1.205-.906-.987-2.18-1.56-3.625-1.56-2.696 0-4.899 2.203-4.899 4.922 0 .39.046.769.126 1.124a13.99 13.99 0 0 1-10.141-5.14 4.87 4.87 0 0 0-.665 2.467c0 1.709.86 3.224 2.191 4.084-.815 0-1.572-.23-2.237-.574v.034c0 2.386 1.698 4.382 3.946 4.83a4.84 4.84 0 0 1-2.214.08 4.91 4.91 0 0 0 4.589 3.419c-1.74 1.377-3.896 2.122-6.115 2.111-.39 0-.78-.023-1.17-.069a13.93 13.93 0 0 0 7.549 2.214c9.04 0 14.008-7.503 14.008-14.008 0-.218 0-.425-.012-.642.964-.688 1.79-1.56 2.455-2.558z"
        fill="currentColor"
      />
    </svg>
  );
...
export const Facebook: FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      <path
        d="M28 16.03C28 9.389 22.624 4 16 4S4 9.389 4 16.03c0 5.822 4.128 10.671 9.6 11.789v-8.18h-2.4V16.03h2.4v-3.008a4.21 4.21 0 0 1 4.2-4.211h3v3.609h-2.4c-.66 0-1.2.541-1.2 1.203v2.406h3.6v3.609h-3.6V28A12.02 12.02 0 0 0 28 16.03z"
        fill="currentColor"
      />
    </svg>
  );
